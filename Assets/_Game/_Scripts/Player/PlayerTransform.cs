...
public class PlayerTransform : NetworkBehaviour
{
    ...
    /// </summary>
    [SerializeField] private bool _isServerAuthoritative;
    ...
    private void Awake()
    {
        ...
        NetworkVariableWritePermission permission = _isServerAuthoritative
    ...
    private void TransmitState()
    {
        ...
        if (IsServer || !_isServerAuthoritative)
    ...
    private void ConsumeState()
    {
        ...
        _rb.MovePosition(Vector3.SmoothDamp(_rb.position, _playerState.Value.Position, ref _posVel,
